...
/*
 * This example reads WB_IO1 and WB_IO2 pin value for interrupt, if the pin value
 * goes from high to low, then light the green or blue led.
 */
...
void setup() {
	...
	// initialize interrupt pin 1 and pin 2 as an input with
	// the internal pull-up resistor enabled
